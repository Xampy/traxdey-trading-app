...
class TTimeWorkerSignals(QObject):
	"""
...
class TTimeWorker(QRunnable):
	"""
		docstring for TTimeNexPeriod
		
		from a given date '2020.03.56' calculate 
		thenext period date adding the predict period
